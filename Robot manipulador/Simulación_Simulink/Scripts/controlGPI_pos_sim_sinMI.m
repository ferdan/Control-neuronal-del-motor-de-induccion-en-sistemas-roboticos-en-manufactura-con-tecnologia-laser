...
for unc_sel = robot_params_uncertainty
    for tr_sel = 3
        ...
        elseif tr_muestra == 0 && ndof == 6
            ...
            tsim = toolpath_time(end) + t_tr_init;
            t_init = 0:tstep:t_tr_init;
            ...
            tr_t = cat(2,t_init(1:end-1),t_tr_init + toolpath_time');
        ...
        NN_RBF_params = setup_RBF_nets(ndof,q');
        ...
        if ndof == 2
            simname = 'controlGPI_pos_2dof_sinMI';
        elseif ndof == 3
            simname = 'controlGPI_pos_3dof_sinMI';
        elseif ndof == 6
            simname = 'controlGPI_pos_6dof_sinMI';
        end
