...
% Referencias %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tau_Rrefs = 0:0.5:1; % porcentaje de valor nominal
...
w_R_arr = zeros(data_size);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
str_dir_graficas = "graficas_PBC_control_tauR_caso_01";
%str_dir_graficas = "";
...
for i = 1:size(tau_Rrefs,2)
    ...
    tau_Lref = tau_Rref;%Perfil_trayectoria(tsim,tstep,tau_Rref_perfil,MI_motor.tau_Rnom*tau_Rrefs(i));
    ...
    v_peaks_arr(i) = max(out.u_S3abc.data(:,1));
    i_peaks_arr(i) = max(out.i_S3abc.data(:,1));

    v_f_arr(i) = v_peaks(1,2);

    ind1 = find(out.tout==tsim-1);
    ind2 = find(out.tout==tsim);
    p_elect_avg_arr(i) = mean(out.P_elect.Data(ind1:ind2));
    p_mech_avg_arr(i) = mean(out.P_mech.Data(ind1:ind2));
    w_R_arr(i) = mean(out.w_R.Data(ind1:ind2));

end

Control_MI_PBC_tauR_caso_01_graficas;
